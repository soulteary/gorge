...
`internal/contracts` 一共 829 行（`render.go` 20 + `diff.go` 42 + `notification.go` 37 + `mailer.go` 74 + `search.go` 150 + `filestorage.go` 41 + `webhook.go` 81 + `conduit.go` 56 + `taskqueue.go` 185 + `dbapi.go` 143），装的是过网络的数据结构，包注释写明了它的地位：
