...
func sendMail(deps *Deps) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		result, err := deps.Dispatcher.SendWith(c.Request().Context(), msg, req.MailerKeys)
		if err != nil {
			if IsPermanent(err) {
...
func listMailers(deps *Deps) echo.HandlerFunc {
	return func(c echo.Context) error {
